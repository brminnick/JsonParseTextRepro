...
1. Install the VS for Mac Preview Build available on 13 September 0300 UTC (additional environment information, below)
2. In Visual Studio for Mac, Open JsonParseTextRepro.sln
3. Set the Build Configration to RELEASE
